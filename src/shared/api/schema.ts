...
export type SchemaPlaylistImagesOutputDto =
...
export type SchemaPlaylistAttributesDto =
  components["schemas"]["PlaylistAttributesDto"];
export type SchemaPlaylistListItemJsonApiData =
  components["schemas"]["PlaylistListItemJsonApiData"];
export type SchemaGetMyPlaylistsOutput =
  components["schemas"]["GetMyPlaylistsOutput"];
export type SchemaCreatePlaylistRequestPayload =
  components["schemas"]["CreatePlaylistRequestPayload"];
export type SchemaPlaylistOutputAttributes =
  components["schemas"]["PlaylistOutputAttributes"];
export type SchemaPlaylistOutput = components["schemas"]["PlaylistOutput"];
export type SchemaGetPlaylistOutput =
  components["schemas"]["GetPlaylistOutput"];
...
export type SchemaGetTracksRequestPayload =
  components["schemas"]["GetTracksRequestPayload"];
...
export type SchemaArtistRelationship =
  components["schemas"]["ArtistRelationship"];
export type SchemaArtistsRelationship =
  components["schemas"]["ArtistsRelationship"];
export type SchemaTrackRelationships =
  components["schemas"]["TrackRelationships"];
export type SchemaTrackListItemOutput =
...
export type SchemaIncludedArtistOutput =
  components["schemas"]["IncludedArtistOutput"];
export type SchemaGetTrackListOutput =
  components["schemas"]["GetTrackListOutput"];
export type SchemaPlaylistTrackAttributes =
...
export type SchemaGetPlaylistTrackListOutput =
  components["schemas"]["GetPlaylistTrackListOutput"];
export type SchemaGetArtistOutput = components["schemas"]["GetArtistOutput"];
export type SchemaTrackDetailsAttributes =
  components["schemas"]["TrackDetailsAttributes"];
export type SchemaTrackDetailsData = components["schemas"]["TrackDetailsData"];
export type SchemaGetTrackDetailsOutput =
  components["schemas"]["GetTrackDetailsOutput"];
export type SchemaReactionOutput = components["schemas"]["ReactionOutput"];
export type SchemaGetPlaylistsRequestPayload =
  components["schemas"]["GetPlaylistsRequestPayload"];
export type SchemaJsonApiMetaWithPaging =
  components["schemas"]["JsonApiMetaWithPaging"];
export type SchemaGetPlaylistsOutput =
  components["schemas"]["GetPlaylistsOutput"];
export type SchemaReorderTracksRequestPayload =
  components["schemas"]["ReorderTracksRequestPayload"];
export type SchemaUpdateTrackRequestPayload =
  components["schemas"]["UpdateTrackRequestPayload"];
export type SchemaTrackOutputAttributes =
  components["schemas"]["TrackOutputAttributes"];
...
export type SchemaCreateArtistRequestPayload =
  components["schemas"]["CreateArtistRequestPayload"];
export type SchemaLoginRequestPayload =
  components["schemas"]["LoginRequestPayload"];
export type SchemaRefreshOutput = components["schemas"]["RefreshOutput"];
export type SchemaBadRequestException =
  components["schemas"]["BadRequestException"];
export type SchemaUnauthorizedException =
  components["schemas"]["UnauthorizedException"];
export type SchemaRefreshRequestPayload =
  components["schemas"]["RefreshRequestPayload"];
export type SchemaLogoutRequestPayload =
  components["schemas"]["LogoutRequestPayload"];
export type SchemaGetMeOutput = components["schemas"]["GetMeOutput"];
export type SchemaCreateTagRequestPayload =
  components["schemas"]["CreateTagRequestPayload"];
